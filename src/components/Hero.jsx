...
export default function Hero({ onOpenSearch }) {
  ...
  const orbitalNodes = [
    ...
    <section 
      className="hero-desktop-mobile-fix relative min-h-[70vh] sm:min-h-[80vh] lg:min-h-[85vh] pt-16 sm:pt-20 lg:pt-20 pb-6 sm:pb-8 lg:pb-10 bg-[#FAF8F5] overflow-hidden flex flex-col justify-between select-none"

...
export default function WhyChooseSolahanaEstate() {
  const features = [
    {
      icon: ShieldCheck,
      title: 'Personalized Estate Planning',
      desc: 'Custom estate blueprints tailored around your family structure, real estate holdings, and legacy vision.',
    },
    {
      icon: Heart,
      title: 'Family-Centric Wealth Planning',
      desc: 'Empathetic fiduciary approach ensuring your spouse, children, and beneficiaries remain protected.',
    },
    {
      icon: Award,
      title: 'Transparent Planning Process',
      desc: 'Legal & SEBI-aligned fiduciary model with 100% clarity, zero hidden fees, or distributor conflicts.',
    },
    {
      icon: Sparkles,
      title: 'Long-Term Legacy Strategy',
      desc: 'Comprehensive multi-generational succession roadmaps that safeguard your wealth for decades to come.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16 space-y-3">
          ...
          <p className="text-sm sm:text-base text-[#475569]">
            Disciplined legacy architecture ensuring your multi-generational wealth is protected.
          </p>
        </div>

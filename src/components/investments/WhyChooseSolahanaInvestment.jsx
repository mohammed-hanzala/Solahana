...
import { ShieldCheck, Award, RefreshCw, LayoutDashboard } from 'lucide-react';

export default function WhyChooseSolahanaInvestment() {
  const features = [
    {
      icon: ShieldCheck,
      title: 'Zero-Commission Direct Investing',
      desc: 'Invest in 100% direct plan mutual funds, saving up to 1.5% annually in distributor commission markups.',
    },
    {
      icon: Award,
      title: 'Unbiased Fiduciary Planning',
      desc: 'SEBI-registered fiduciary model with zero commission kickbacks, keeping advice strictly aligned with your interest.',
    },
    {
      icon: RefreshCw,
      title: 'Dynamic Portfolio Rebalancing',
      desc: 'Periodic reviews and automated rebalancing to keep risk exposure aligned with your concrete life milestones.',
    },
    {
      icon: LayoutDashboard,
      title: 'Integrated Wealth Dashboard',
      desc: 'Unified tracking across domestic equity, fixed-income bonds, international assets, and mutual funds in one view.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16 space-y-3">
          ...
          <p className="text-sm sm:text-base text-[#475569]">
            Transparent, fiduciary investment management designed exclusively for high-net-worth compounding.
          </p>
        </div>

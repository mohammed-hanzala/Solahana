  ...
  return (
    <section className="py-24 md:py-32 relative overflow-hidden bg-[#FFFFFF] border-t border-[#2F5BC7]/20">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-30">
        <div className="absolute top-10 left-1/4 w-2 h-2 rounded-full bg-[#5A7FD6] animate-ping" />
        <div className="absolute bottom-14 right-1/4 w-2 h-2 rounded-full bg-[#1A3170] animate-ping" />
      </div>

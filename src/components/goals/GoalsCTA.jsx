  ...
  return (
    <section className="py-24 md:py-32 relative overflow-hidden bg-[#020B2D] border-t border-[#C8A24A]/20">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-30">
        <div className="absolute top-10 left-1/3 w-2 h-2 rounded-full bg-[#E8C878] animate-ping" />
        <div className="absolute bottom-12 right-1/3 w-2 h-2 rounded-full bg-[#C8A24A] animate-ping" />
      </div>

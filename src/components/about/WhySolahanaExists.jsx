...
export default function WhySolahanaExists() {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 relative overflow-hidden bg-[#FFFDF8]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-center">
          ...
          >
            <div className="p-7 sm:p-8 rounded-[22px] bg-white border border-[#C89A4B]/20 shadow-[0_10px_30px_rgba(200,154,75,0.06)] text-left space-y-6">
              
              <div className="flex items-center justify-between pb-4 border-b border-[#C89A4B]/20">
                <span className="text-xs font-sans font-bold text-[#9A7326] uppercase tracking-wider">
                  FINANCIAL TRANSFORMATION
                </span>
                <span className="text-[10px] text-[#64748B] px-2.5 py-1 rounded bg-[#FCFAF5] border border-[#C89A4B]/20">
                  THE PARADIGM SHIFT
                </span>
              </div>

              {/* Before: Financial Chaos Block */}
              <div className="p-4 rounded-2xl bg-red-50/70 border border-red-200/80 space-y-2 relative">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-red-700 flex items-center gap-1.5 font-sans">
              ...
              {pillars.map((pillar, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className="p-5 rounded-[22px] bg-white border border-[#C89A4B]/20 hover:border-[#C89A4B] shadow-[0_10px_30px_rgba(200,154,75,0.06)] hover:shadow-md transition-all flex items-start space-x-4"
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#9A7326] font-sans font-semibold mt-0.5">
                        {pillar.subtitle}
                      </p>
                      <p className="text-xs text-[#475569] font-sans leading-relaxed mt-1">
                        {pillar.description}
                      </p>
                    </div>
                  </motion.div>

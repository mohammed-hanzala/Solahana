...
export default function AboutCTA({ onStartPlanning, onBookConsultation }) {
  return (
    <section className="py-14 md:py-20 relative overflow-hidden bg-[#FAF8F5] border-t border-[#C89A4B]/20">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <motion.div
          ...
          className="p-8 sm:p-12 lg:p-14 rounded-3xl bg-white border border-[#C89A4B]/30 shadow-xl space-y-6"
        >
          {/* Small Top Badge */}
          ...
          {/* Heading */}
          <h2 className="text-3xl sm:text-5xl font-serif-luxury font-bold text-[#0F172A] leading-tight tracking-tight">
          ...
          <div className="pt-6 border-t border-[#C89A4B]/20 flex flex-wrap items-center justify-center gap-6 text-xs text-[#64748B] font-inter">

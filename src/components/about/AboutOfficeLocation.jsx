        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-6 space-y-6 flex flex-col justify-between text-left">
            ...
            <motion.div
              ...
              className="p-7 sm:p-8 rounded-3xl bg-[#FAF8F5] border border-[#E7D7B5] shadow-lg space-y-6"
            >
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-2xl bg-white border border-[#C89B3C]/40 text-[#C89B3C] flex items-center justify-center shadow-xs">
                  <Building2 className="w-6 h-6" />
                </div>
                <div>
                  <span className="text-xs font-mono text-[#B8860B] uppercase tracking-wider font-semibold">Corporate Headquarters</span>
                  <h3 className="font-serif-luxury text-2xl font-bold text-[#0F172A]">Mumbai, India</h3>
                </div>
              </div>

              <div className="space-y-4 pt-4 border-t border-[#E7D7B5]/60 text-sm text-[#475569]">
                ...
                <div className="flex items-center gap-3">
                  <Mail className="w-5 h-5 text-[#C89B3C] shrink-0" />
                  <div>
                    <span className="font-medium text-[#64748B]">Email: </span>
                    <a href="mailto:info@solahana.com" className="text-[#0F172A] hover:text-[#B8860B] transition-colors font-bold">info@solahana.com</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex flex-col space-y-0.5">
                    ...
                    <a href="tel:+917304442171" className="text-[#0F172A] hover:text-[#B8860B] transition-colors font-bold">+91 73044 42171</a>
                    <a href="tel:+917021295187" className="text-[#0F172A]/80 hover:text-[#B8860B] transition-colors font-semibold text-xs">+91 70212 95187</a>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="p-7 sm:p-8 rounded-3xl bg-[#FAF8F5] border border-[#E7D7B5] shadow-lg text-left"
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 rounded-2xl bg-white border border-[#E7D7B5] space-y-1">
                  <div className="flex items-center gap-2 text-xs text-[#B8860B] font-mono uppercase font-semibold">
          ...
          <motion.div
            ...
            className="lg:col-span-6 relative rounded-3xl overflow-hidden border border-[#E7D7B5] shadow-xl bg-[#FAF8F5] flex flex-col justify-between min-h-[420px]"
          >
            ...
            <div className="relative z-10 flex-1 flex flex-col items-center justify-center p-8 text-center my-auto">
              <div className="relative mb-6">
                <div className="w-16 h-16 rounded-2xl bg-[#FAF8F5] border-2 border-[#C89B3C] shadow-lg flex items-center justify-center">
                  <MapPin className="w-8 h-8 text-[#C89B3C]" />
                </div>
              </div>
            ...
            <div className="relative z-10 p-4 bg-white border-t border-[#E7D7B5] text-xs text-[#64748B] text-center font-mono">

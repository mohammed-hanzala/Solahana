...
export default function RetirementCalculator() {
  ...
  return (
    <div className="relative z-10 bg-[#FAF8F5]">
      ...
      <section id="retirement-calculator" className="py-16 sm:py-24 bg-[#FAF8F5] relative overflow-hidden border-t border-[#E7D7B5]">
            ...
            >
              ...
              <div className="flex items-center justify-between border-b border-[#E7D7B5]/60 pb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    onClick={handleSave}
                    className="p-2 rounded-xl bg-[#FAF8F5] border border-[#E7D7B5] text-[#B8860B] hover:bg-[#FAF8F5] hover:border-[#C89B3C] transition-colors text-xs font-semibold flex items-center gap-1 cursor-pointer"
                  >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="block text-xs font-semibold text-[#0F172A]">Current Age (Years)</label>
                  <input
                    type="number"
                    min="18"
                    max="70"
                ...
                <div className="space-y-1.5">
                  <label className="block text-xs font-semibold text-[#0F172A]">Retirement Age (Years)</label>
                  <input
                    type="number"
                    min={currentAge + 1}
                    max="85"
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center text-xs">
                  <label className="font-semibold text-[#0F172A]">Monthly Living Expenses Today</label>
                  <span className="font-mono text-sm font-bold text-[#B8860B]">{formatINR(monthlyExpensesNow)}</span>
                </div>
                <input
                  type="number"
                  min="10000"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="block text-xs font-semibold text-[#0F172A]">Expected Inflation (%)</label>
                  <input
                    type="number"
                    step="0.5"
                    min="1"
                ...
                <div className="space-y-1.5">
                  <label className="block text-xs font-semibold text-[#0F172A]">Expected Return (%)</label>
                  <input
                    type="number"
                    step="0.5"
                    min="1"
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center text-xs">
                  <label className="font-semibold text-[#0F172A]">Existing Retirement Savings / Investments</label>
            ...
            >
              ...
              <div className="p-6 sm:p-7 rounded-3xl bg-gradient-to-br from-[#FFFDF9] via-[#FAF8F5] to-white border-2 border-[#C89B3C] shadow-xl space-y-3 relative overflow-hidden">
                <div className="flex items-center justify-between">
                  ...
                  <span className="px-2.5 py-1 rounded-full bg-[#FAF8F5] border border-[#C89B3C]/40 text-[#B8860B] text-[10px] font-mono font-semibold">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-5 rounded-2xl bg-white border border-[#E7D7B5] shadow-sm space-y-1.5">
                  <span className="text-[10px] uppercase font-mono font-bold text-[#B8860B]">Future Monthly Expense</span>
                  <div className="text-xl sm:text-2xl font-bold font-mono text-[#0F172A]">{formatINR(result.futureMonthlyExpense)}</div>

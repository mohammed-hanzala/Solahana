      ...
      <div className="w-full h-full rounded-[24px] bg-white border border-[#E7D7B5] p-6 shadow-[0_10px_30px_rgba(200,155,60,0.08)] backdrop-blur-xl relative overflow-hidden flex flex-col justify-between text-left">
        ...
        <div className="my-2 w-full flex items-center justify-center">
          <svg className="w-full h-36" viewBox="0 0 320 140" fill="none">
            ...
            <path d="M 148 58 L 172 58 L 168 105 L 152 105 Z" fill="#1A1A1A" />
            ...
            <g transform="translate(30, 40)">
              <rect width="80" height="45" rx="6" fill="#FFFFFF" stroke="#E7D7B5" strokeWidth="1.5" />
              <text x="40" y="16" fill="#666666" fontSize="8" textAnchor="middle">Treasury Yield</text>
              <text x="40" y="31" fill="#1A1A1A" fontSize="12" fontWeight="bold" textAnchor="middle">9.2% p.a.</text>
            </g>

            <g transform="translate(210, 45)">
              <rect width="80" height="45" rx="6" fill="#FFFFFF" stroke="#E7D7B5" strokeWidth="1.5" />
              <text x="40" y="16" fill="#666666" fontSize="8" textAnchor="middle">Keyman Cover</text>
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="p-2.5 rounded-xl bg-[#F8F5EF] border border-[#E7D7B5] text-center">
            <div className="text-[10px] text-[#666666]">Keyman Insurance</div>
            <div className="text-xs font-bold text-[#1A1A1A] font-sora">₹10.0 Cr Shield</div>
          </div>
          <div className="p-2.5 rounded-xl bg-[#F8F5EF] border border-[#E7D7B5] text-center">
            <div className="text-[10px] text-[#666666]">Corporate Tax</div>
            <div className="text-xs font-bold text-[#B8860B] font-sora">Optimized</div>
          </div>
          <div className="p-2.5 rounded-xl bg-[#F8F5EF] border border-[#E7D7B5] text-center">
            <div className="text-[10px] text-[#666666]">Succession Trust</div>

      ...
      <div className="w-full h-full rounded-[24px] bg-white border border-[#E7D7B5] p-6 shadow-[0_10px_30px_rgba(200,155,60,0.08)] backdrop-blur-xl relative overflow-hidden flex flex-col justify-between text-left">
        <div className="flex items-center justify-between border-b border-[#E7D7B5] pb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="text-sm font-serif-luxury font-bold text-[#1A1A1A]">Child Higher Studies Fund</div>
              <div className="text-[11px] text-[#666666]">Step-up SIP Education Corpus Architecture</div>
            </div>
          </div>
        ...
        <div className="my-2 w-full flex items-center justify-center">
          <svg className="w-full h-36" viewBox="0 0 320 140" fill="none">
            ...
            <rect x="20" y="20" width="280" height="100" rx="12" fill="#F8F5EF" stroke="#E7D7B5" strokeWidth="1" strokeDasharray="3 3" />
            
            {/* Human Student in Graduation Gown */}
            <circle cx="160" cy="45" r="10" fill="#FDBA74" />
            {/* Graduation Cap */}
            <path d="M 140 38 L 160 30 L 180 38 L 160 44 Z" fill="#1A1A1A" />
            <path d="M 160 44 V 50" stroke="#C89B3C" strokeWidth="2" />
            {/* Gown */}
            <path d="M 145 58 L 175 58 L 172 105 L 148 105 Z" fill="#1A1A1A" />
            <path d="M 152 58 L 168 58 L 160 85 Z" fill="#C89B3C" />

            {/* Left & Right Education Corpus Indicators */}
            <g transform="translate(35, 45)">
              <rect width="85" height="45" rx="6" fill="#FFFFFF" stroke="#E7D7B5" strokeWidth="1.5" />
              <text x="42.5" y="16" fill="#666666" fontSize="8" textAnchor="middle">Target Fund</text>
              <text x="42.5" y="31" fill="#1A1A1A" fontSize="12" fontWeight="bold" textAnchor="middle">₹50.0 Lakhs</text>
            </g>

            <g transform="translate(200, 45)">
              <rect width="85" height="45" rx="6" fill="#FFFFFF" stroke="#E7D7B5" strokeWidth="1.5" />
              <text x="42.5" y="16" fill="#666666" fontSize="8" textAnchor="middle">Monthly SIP</text>
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="p-2.5 rounded-xl bg-[#F8F5EF] border border-[#E7D7B5] text-center">
            <div className="text-[10px] text-[#666666]">Education Target</div>
            <div className="text-xs font-bold text-[#1A1A1A] font-sora">₹50.0 Lakhs</div>
          </div>
          <div className="p-2.5 rounded-xl bg-[#F8F5EF] border border-[#E7D7B5] text-center">
            <div className="text-[10px] text-[#666666]">Inflation Adjustment</div>
            <div className="text-xs font-bold text-[#B8860B] font-sora">8.0% p.a.</div>
          </div>
          <div className="p-2.5 rounded-xl bg-[#F8F5EF] border border-[#E7D7B5] text-center">
            <div className="text-[10px] text-[#666666]">Step-up Rate</div>

      ...
      <div className="w-full h-full rounded-[24px] bg-white border border-[#E7D7B5] p-6 shadow-[0_10px_30px_rgba(200,155,60,0.08)] backdrop-blur-xl relative overflow-hidden flex flex-col justify-between text-left">
        <div className="flex items-center justify-between border-b border-[#E7D7B5] pb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="text-sm font-serif-luxury font-bold text-[#1A1A1A]">Dream Home Down Payment</div>
              <div className="text-[11px] text-[#666666]">Real Estate & Debt Optimization Buffer</div>
            </div>
          </div>
        ...
        <div className="my-2 w-full flex items-center justify-center">
          <svg className="w-full h-36" viewBox="0 0 320 140" fill="none">
            {/* House Outline */}
            <path d="M 120 70 L 160 35 L 200 70 V 115 H 120 Z" fill="#F8F5EF" stroke="#E7D7B5" strokeWidth="2" />
            ...
            <path d="M 77 67 L 93 67 L 90 105 L 80 105 Z" fill="#1A1A1A" />
            ...
            <g transform="translate(210, 45)">
              <rect width="90" height="50" rx="8" fill="#FFFFFF" stroke="#E7D7B5" strokeWidth="1.5" />
              <text x="45" y="18" fill="#666666" fontSize="8" textAnchor="middle">Down Payment</text>
              <text x="45" y="34" fill="#1A1A1A" fontSize="13" fontWeight="bold" textAnchor="middle">₹35.0 Lakhs</text>
            </g>
          </svg>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="p-2.5 rounded-xl bg-[#F8F5EF] border border-[#E7D7B5] text-center">
            <div className="text-[10px] text-[#666666]">Down Payment</div>
            <div className="text-xs font-bold text-[#1A1A1A] font-sora">₹35.0 Lakhs</div>
          </div>
          <div className="p-2.5 rounded-xl bg-[#F8F5EF] border border-[#E7D7B5] text-center">
            <div className="text-[10px] text-[#666666]">EMI Safety Guard</div>
            <div className="text-xs font-bold text-[#B8860B] font-sora">&lt; 35% Income</div>
          </div>
          <div className="p-2.5 rounded-xl bg-[#F8F5EF] border border-[#E7D7B5] text-center">
            <div className="text-[10px] text-[#666666]">Loan Principal</div>

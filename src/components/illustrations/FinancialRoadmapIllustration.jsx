...
export default function FinancialRoadmapIllustration() {
  ...
  return (
    <div className="w-full bg-[#0F172A]/90 border border-[#C8A24A]/30 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl relative overflow-hidden text-left">
            ...
            return (
              <motion.button
                ...
                className={`p-4 rounded-2xl border text-left transition-all cursor-pointer flex flex-col justify-between relative group ${
                  isSelected
                    ? 'bg-gradient-to-b from-[#1E293B] to-[#0F172A] border-[#C8A24A] shadow-[0_10px_30px_rgba(200,154,75,0.3)] ring-2 ring-[#C8A24A]/40'
              ...
              >
                ...
                <div 
                  className={`w-11 h-11 rounded-xl flex items-center justify-center mb-3 transition-transform group-hover:scale-110 ${
                    isSelected ? 'bg-[#C8A24A] text-[#0F172A] shadow-lg' : 'bg-white/10 text-white'
                  }`}
                >

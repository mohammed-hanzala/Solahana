...
export default function RetirementHeroIllustration() {
  return (
    <div className="relative w-full max-w-[540px] aspect-[4/3] flex items-center justify-center select-none mx-auto">
      ...
      <div className="w-full h-full rounded-3xl bg-white/90 border border-[#E7D7B5] p-6 sm:p-8 shadow-2xl backdrop-blur-xl relative overflow-hidden flex flex-col justify-between text-left border-t-2 border-t-[#C89B3C]/40">
        
        {/* Top Header Badge Strip */}
        <div className="flex items-center justify-between border-b border-[#E7D7B5]/60 pb-4">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 rounded-xl bg-[#FAF8F5] border border-[#C89B3C]/40 text-[#C89B3C] flex items-center justify-center font-bold shadow-sm">
          ...
          <span className="px-3 py-1 rounded-full bg-[#FAF8F5] border border-[#C89B3C]/40 text-[#B8860B] font-mono text-[10px] font-semibold flex items-center gap-1.5 shadow-sm">
        ...
        <div className="my-2 w-full flex items-center justify-center">
          <svg className="w-full h-44 drop-shadow-lg overflow-visible" viewBox="0 0 360 160" fill="none">
            ...
            <circle cx="180" cy="80" r="55" fill="#FAF8F5" stroke="#E7D7B5" strokeWidth="1.5" />
            ...
            <path d="M 60 64 L 90 64 L 86 120 L 64 120 Z" fill="#0F172A" />
            ...
            <path d="M 272 48 C 272 32, 298 32, 298 48 Z" fill="#0F172A" />
            <path d="M 270 64 L 300 64 L 296 120 L 274 120 Z" fill="#0F172A" />
            {/* Arm presenting target corpus */}
            <path d="M 278 74 Q 240 68 215 65" stroke="#0F172A" strokeWidth="4" strokeLinecap="round" fill="none" />
            ...
            <text x="237" y="137" fill="#0F172A" fontSize="13" fontFamily="sans-serif" fontWeight="bold">₹5.20 Crore</text>
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3">
          <div className="p-2.5 rounded-xl bg-[#FAF8F5] border border-[#E7D7B5]/80 text-center">
            <div className="text-[10px] font-semibold text-[#64748B] uppercase tracking-wider">Current Age</div>
            <div className="text-xs sm:text-sm font-bold text-[#0F172A] font-sora">32 Years</div>
          </div>
          <div className="p-2.5 rounded-xl bg-[#FAF8F5] border border-[#E7D7B5]/80 text-center">

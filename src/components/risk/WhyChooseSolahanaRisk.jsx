...
import { ShieldCheck, UserCheck, Heart, Award } from 'lucide-react';

export default function WhyChooseSolahanaRisk() {
  const features = [
    {
      icon: UserCheck,
      title: 'Personalized Risk Planning',
      desc: 'Custom risk audits tailored around your age, outstanding liabilities, dependents, and cashflows.',
    },
    {
      icon: ShieldCheck,
      title: 'Comprehensive Protection Strategy',
      desc: '360° financial shield combining pure term cover, super top-up health, and liquid emergency reserves.',
    },
    {
      icon: Heart,
      title: 'Long-Term Family Security',
      desc: 'Ensure your family’s core life goals—education, home ownership, and lifestyle—stay 100% on track.',
    },
    {
      icon: Award,
      title: 'Transparent Planning Process',
      desc: 'SEBI/IRDA aligned fiduciary advice with zero mis-selling, hidden commissions, or endowment drags.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16 space-y-3">
          ...
          <p className="text-sm sm:text-base text-[#475569]">
            Unbiased fiduciary risk management engineered strictly for your family’s protection.
          </p>
        </div>

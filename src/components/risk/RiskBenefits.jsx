    ...
    <section className="py-16 sm:py-24 bg-[#FAF8F5] relative overflow-hidden border-t border-[#E7D7B5]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20 sm:space-y-28">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-[#E7D7B5] text-xs font-semibold text-[#B8860B] shadow-xs">
              <Sparkles className="w-3.5 h-3.5 text-[#C89B3C]" />
              <span>Family Security</span>
            </div>

            <h3 className="text-2xl sm:text-3xl font-serif-luxury font-bold text-[#0F172A] leading-tight">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={idx} className="flex items-start gap-3 text-xs sm:text-sm text-[#0F172A] font-medium">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={idx} className="flex items-start gap-3 text-xs sm:text-sm text-[#0F172A] font-medium">
                  <ShieldCheck className="w-4 h-4 text-[#C89B3C] shrink-0 mt-0.5" />
                  <span>{item}</span>
                </li>
              ))}
            </ul>
          ...
          >
            <div className="w-full max-w-[480px] p-6 rounded-3xl bg-white border border-[#E7D7B5] shadow-xl">

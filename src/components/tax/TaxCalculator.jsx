...
export default function TaxCalculator() {
  ...
  return (
    <section id="tax-calculator" className="py-16 sm:py-24 bg-[#FAF8F5] relative overflow-hidden border-t border-[#E7D7B5]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          >
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-xs">
                <label className="font-semibold text-[#0F172A]">Gross Annual Income (₹)</label>
                <span className="font-mono text-sm font-bold text-[#B8860B]">{formatINR(grossIncome)}</span>
              </div>
              <input
                type="number"
                min="300000"
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-xs">
                <label className="font-semibold text-[#0F172A]">Section 80C Deductions (ELSS, PPF, EPF)</label>
                <span className="font-mono text-sm font-bold text-[#0F172A]">{formatINR(sec80C)}</span>
              </div>
              <input
                type="number"
                min="0"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="block text-xs font-semibold text-[#0F172A]">Sec 80D Health Cover (₹)</label>
                <input
                  type="number"
                  min="0"
                  max="100000"
              ...
              <div className="space-y-1.5">
                <label className="block text-xs font-semibold text-[#0F172A]">NPS 80CCD 1B (₹)</label>
                <input
                  type="number"
                  min="0"
                  max="50000"
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-xs">
                <label className="font-semibold text-[#0F172A]">HRA / Home Loan Interest / Other Deductions</label>
                <span className="font-mono text-sm font-bold text-[#0F172A]">{formatINR(hraOther)}</span>
              </div>
              <input
                type="number"
                min="0"
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              {/* Old Regime Card */}
              <div className={`p-5 rounded-2xl bg-white border text-left space-y-2 transition-all ${taxResult.recommendedRegime === 'Old Regime' ? 'border-[#C89B3C] shadow-md bg-[#FFFDF9]' : 'border-[#E7D7B5] shadow-xs'}`}>
                <div className="flex items-center justify-between">
                  <span className="text-xs font-mono font-bold text-[#0F172A]">OLD REGIME</span>
                  {taxResult.recommendedRegime === 'Old Regime' && (
                    <span className="text-[10px] uppercase font-mono font-bold text-[#B8860B]">Optimal</span>
                  )}
                </div>
                <div className="text-xl sm:text-2xl font-bold font-mono text-[#0F172A]">
              ...
              {/* New Regime Card */}
              <div className={`p-5 rounded-2xl bg-white border text-left space-y-2 transition-all ${taxResult.recommendedRegime === 'New Regime' ? 'border-emerald-500 shadow-md bg-emerald-50/20' : 'border-[#E7D7B5] shadow-xs'}`}>
                <div className="flex items-center justify-between">
                  <span className="text-xs font-mono font-bold text-[#0F172A]">NEW REGIME</span>
            ...
            <div className="p-6 rounded-3xl bg-white border border-[#E7D7B5] shadow-xl space-y-4">
              ...
              <div className="space-y-2.5 text-xs">
                <div className="flex justify-between items-center py-1.5 border-b border-[#E7D7B5]/50">
                  ...
                  <span className="font-mono font-bold text-[#0F172A]">{formatINR(sec80C)}</span>
                </div>
                <div className="flex justify-between items-center py-1.5 border-b border-[#E7D7B5]/50">
                  <span className="text-[#64748B]">Section 80D (Health Insurance)</span>
                  <span className="font-mono font-bold text-[#0F172A]">{formatINR(sec80D)}</span>
                </div>
                <div className="flex justify-between items-center py-1.5 border-b border-[#E7D7B5]/50">
                  <span className="text-[#64748B]">Section 80CCD 1B (NPS Additional)</span>
                  <span className="font-mono font-bold text-[#0F172A]">{formatINR(nps80CCD)}</span>
                </div>
                <div className="flex justify-between items-center py-1.5">
                  <span className="text-[#64748B]">HRA / Home Loan &amp; Other Deductions</span>
                  <span className="font-mono font-bold text-[#0F172A]">{formatINR(hraOther)}</span>
                </div>
              </div>
            </div>

...
export default function InvestHeroIllustration({ type = 'mutual-funds' }) {
  switch (type) {
    case 'domestic-equity':
      return (
        <svg viewBox="0 0 500 400" className="w-full h-auto drop-shadow-2xl select-none" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Chart Board */}
          <rect x="60" y="60" width="380" height="260" rx="24" fill="#0A192F" stroke="#C89B3C" strokeWidth="2.5" />
          {/* Grid lines */}
          ...
          {/* Glowing Stock Nodes */}
          <circle cx="160" cy="210" r="6" fill="#C89B3C" />
          <circle cx="220" cy="230" r="6" fill="#C89B3C" />
          <circle cx="300" cy="130" r="6" fill="#C89B3C" />
          ...
          <g transform="translate(180, 210)">
            ...
            <path d="M55 75 L70 100 L85 75" stroke="#C89B3C" strokeWidth="3" fill="none" />
            <circle cx="70" cy="50" r="22" fill="#D97706" />
            <path d="M48 45 C48 25, 92 25, 92 45 C85 30, 55 30, 48 45" fill="#0F172A" />
            <rect x="58" y="44" width="10" height="8" rx="2" stroke="#C89B3C" strokeWidth="1.5" fill="none" />
            <rect x="72" y="44" width="10" height="8" rx="2" stroke="#C89B3C" strokeWidth="1.5" fill="none" />
            <line x1="68" y1="48" x2="72" y2="48" stroke="#C89B3C" strokeWidth="1.5" />
          </g>
    ...
    case 'international-equity':
      return (
        <svg viewBox="0 0 500 400" className="w-full h-auto drop-shadow-2xl select-none" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Global Globe Grid */}
          <circle cx="250" cy="200" r="130" fill="#0A192F" stroke="#C89B3C" strokeWidth="3" />
          ...
          <text x="200" y="164" fill="#0F172A" fontSize="10" fontWeight="bold" textAnchor="middle">AAPL</text>

          <circle cx="300" cy="150" r="18" fill="#F59E0B" stroke="#FFFFFF" strokeWidth="2" />
          <text x="300" y="154" fill="#0F172A" fontSize="10" fontWeight="bold" textAnchor="middle">MSFT</text>

          <circle cx="270" cy="240" r="18" fill="#10B981" stroke="#FFFFFF" strokeWidth="2" />
          <text x="270" y="244" fill="#0F172A" fontSize="10" fontWeight="bold" textAnchor="middle">NVDA</text>

          {/* USD Currency Hedge Pill */}
          <rect x="130" y="40" width="240" height="42" rx="21" fill="#C89B3C" />
          <text x="250" y="66" fill="#0F172A" fontSize="12" fontWeight="bold" textAnchor="middle">USD CURRENCY HEDGE 🌐</text>
        </svg>
      );
    ...
    case 'bonds':
      return (
        <svg viewBox="0 0 500 400" className="w-full h-auto drop-shadow-2xl select-none" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="250" cy="200" r="170" fill="#C89B3C" opacity="0.1" />
          {/* Bond Certificate Card */}
          <rect x="70" y="70" width="360" height="240" rx="20" fill="#FFFFFF" stroke="#C89B3C" strokeWidth="3" />
          <rect x="85" y="85" width="330" height="210" rx="14" fill="#FAF8F5" stroke="#E7D7B5" strokeWidth="1.5" strokeDasharray="6 4" />
          {/* Certificate Stamp */}
          <circle cx="360" cy="140" r="35" fill="#C89B3C" opacity="0.15" />
          <circle cx="360" cy="140" r="28" fill="none" stroke="#C89B3C" strokeWidth="2" strokeDasharray="3 3" />
          <text x="360" y="145" fill="#9A7326" fontSize="11" fontWeight="bold" textAnchor="middle">AAA RATED</text>
          {/* Bond Text lines */}
          <rect x="110" y="110" width="160" height="14" rx="4" fill="#0F172A" />
          <rect x="110" y="138" width="200" height="8" rx="2" fill="#94A3B8" />
          <rect x="110" y="154" width="140" height="8" rx="2" fill="#94A3B8" />
          {/* Coupon Rate Badge */}
          <rect x="110" y="190" width="180" height="60" rx="14" fill="#0A192F" />
    ...
    case 'ipo':
      return (
        <svg viewBox="0 0 500 400" className="w-full h-auto drop-shadow-2xl select-none" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Rocket Ship */}
          <path d="M250 80 C290 140, 290 220, 250 270 C210 220, 210 140, 250 80 Z" fill="#0F172A" stroke="#C89B3C" strokeWidth="3" />
          ...
          <rect x="70" y="140" width="120" height="44" rx="12" fill="#FFFFFF" stroke="#E7D7B5" strokeWidth="2" />
          <text x="130" y="166" fill="#0F172A" fontSize="11" fontWeight="bold" textAnchor="middle">100% UPI Apply</text>
    ...
    default:
      return (
        <svg viewBox="0 0 500 400" className="w-full h-auto drop-shadow-2xl select-none" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="250" cy="200" r="180" fill="#C89B3C" opacity="0.12" />
          {/* Main Portfolio Sphere */}
          <rect x="80" y="80" width="340" height="240" rx="24" fill="#0F172A" stroke="#C89B3C" strokeWidth="2.5" />
          {/* Bars */}
          <rect x="120" y="220" width="40" height="60" rx="8" fill="#3B82F6" />
          <rect x="180" y="180" width="40" height="100" rx="8" fill="#10B981" />
          <rect x="240" y="140" width="40" height="140" rx="8" fill="#C89B3C" />

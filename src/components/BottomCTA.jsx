...
export default function BottomCTA({ onOpenSearch }) {
  return (
    <section className="relative z-10 py-24 bg-[#020B2D] border-t border-[#C8A24A]/20 overflow-hidden">
      
      {/* Central Golden Backdrop Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[300px] bg-[#C8A24A]/12 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <motion.div
          ...
          className="rounded-[36px] p-8 sm:p-14 bg-gradient-to-r from-[#071C48] via-[#0A2763] to-[#071C48] border-2 border-[#C8A24A]/40 backdrop-blur-2xl text-center space-y-6 shadow-[0_30px_90px_rgba(2,11,45,0.95),0_0_40px_rgba(200,162,74,0.3)] relative overflow-hidden"
        >
          {/* Badge */}
          ...
          {/* Description */}
          <p className="text-base sm:text-lg text-[#BAC6DA] font-inter max-w-xl mx-auto leading-relaxed">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button
              ...
              className="px-7 py-4 rounded-full text-sm font-semibold text-[#F8F7F3] hover:text-[#E8C878] bg-[#020B2D]/80 hover:bg-[#020B2D] border border-[#C8A24A]/30 hover:border-[#C8A24A]/60 backdrop-blur-xl transition-all flex items-center justify-center space-x-2 w-full sm:w-auto"
            >
          ...
          <div className="pt-6 border-t border-[#C8A24A]/15 flex flex-wrap items-center justify-center gap-6 text-xs text-[#BAC6DA]">
            ...
            <span>•</span>
            <span className="flex items-center gap-1.5">
              <Lock className="w-4 h-4 text-[#E8C878]" /> 256-Bit SSL Encryption
            </span>
            <span>•</span>

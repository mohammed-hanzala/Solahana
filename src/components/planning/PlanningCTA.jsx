...
export default function PlanningCTA({ onBookConsultation, onTalkToPlanner }) {
  return (
    <section className="py-24 md:py-32 relative overflow-hidden bg-[#020B2D] border-t border-[#C8A24A]/20">
      ...
      {/* Subtle Floating Particles Accent */}
      <div className="absolute inset-0 pointer-events-none opacity-30">
        <div className="absolute top-12 left-1/4 w-2 h-2 rounded-full bg-[#E8C878] animate-ping" />
        <div className="absolute bottom-16 right-1/4 w-2 h-2 rounded-full bg-[#C8A24A] animate-ping" />
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <div className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-[#020B2D] border border-[#C8A24A]/40 text-[#E8C878] text-xs font-semibold uppercase tracking-widest font-sora shadow-[0_0_20px_rgba(200,162,74,0.3)]">
            ...
            <span>START YOUR FINANCIAL PLAN TODAY</span>
          </div>

          {/* Heading */}
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-serif-luxury font-bold text-[#F8F7F3] leading-tight tracking-tight">
            Let's Build a Financial Plan <br />
            <span className="text-gradient-gold">That Grows With You.</span>
          </h2>

          {/* Description */}
          <p className="text-base sm:text-xl text-[#BAC6DA] font-inter max-w-2xl mx-auto leading-relaxed">
            From your first salary to retirement, SOLAHANA helps you make confident financial decisions backed by fiduciary clarity and zero-commission advisory.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            >
              <PhoneCall className="w-4 h-4 text-[#C8A24A]" />

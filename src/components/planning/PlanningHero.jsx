        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-[#475569] font-inter leading-relaxed max-w-2xl font-normal">
              SOLAHANA helps you create one clear financial roadmap covering <span className="text-[#0F172A] font-semibold">savings</span>, <span className="text-[#0F172A] font-semibold">investments</span>, <span className="text-[#0F172A] font-semibold">taxes</span>, <span className="text-[#0F172A] font-semibold">protection</span>, and <span className="text-[#9A7326] font-semibold">retirement</span>.
            </p>
            ...
            <div className="pt-6 grid grid-cols-3 gap-4 border-t border-[#C89A4B]/20 max-w-xl">
              <div>
                <p className="text-2xl font-bold font-sora text-[#C89A4B]">₹1.84 Cr</p>
                <p className="text-xs text-[#64748B] mt-0.5">Avg Managed Net Worth</p>
              </div>
              <div>
                <p className="text-2xl font-bold font-sora text-[#C89A4B]">100%</p>
                <p className="text-xs text-[#64748B] mt-0.5">Direct Mutual Funds</p>
              </div>
              <div>
                <p className="text-2xl font-bold font-sora text-[#C89A4B]">Zero</p>
                <p className="text-xs text-[#64748B] mt-0.5">Hidden Distributor Fees</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="rounded-3xl p-8 bg-white border border-[#C89A4B]/30 shadow-xl space-y-6">
              ...
              <h3 className="text-2xl font-serif-luxury font-bold text-[#0F172A]">
                Comprehensive 5-Phase Planning Architecture
              </h3>
              <p className="text-sm text-[#475569] font-inter leading-relaxed">
                From emergency risk buffers to tax harvesting and multi-generational estate transfer, SOLAHANA organizes your financial life into one clear roadmap.
              </p>
              <div className="p-4 rounded-xl bg-[#FAF8F5] border border-[#C89A4B]/20 text-xs text-[#9A7326] font-sora font-semibold flex items-center gap-2">
                ...
                <span>SEBI Fiduciary Guaranteed</span>
              </div>
            </div>
          </motion.div>

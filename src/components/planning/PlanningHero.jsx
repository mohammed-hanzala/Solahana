        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-[#475569] leading-relaxed max-w-xl font-sans">
              Organize your income, goal-based investments, risk coverage, and tax optimization into one unified strategy built for life goals.
            </p>
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              <div className="flex items-center gap-2 text-xs font-semibold text-[#0F172A]">
                ...
                <span>360° Cashflow Architecture</span>
              </div>
              <div className="flex items-center gap-2 text-xs font-semibold text-[#0F172A]">
                <ShieldCheck className="w-4 h-4 text-[#C89B3C]" />
                <span>Goal-Aligned Multi-Asset SIPs</span>
              </div>
              <div className="flex items-center gap-2 text-xs font-semibold text-[#0F172A]">
                <ShieldCheck className="w-4 h-4 text-[#C89B3C]" />
                <span>Tax Harvesting &amp; Regime Optimization</span>
              </div>
              <div className="flex items-center gap-2 text-xs font-semibold text-[#0F172A]">
                <ShieldCheck className="w-4 h-4 text-[#C89B3C]" />
                <span>Comprehensive Family Risk Shield</span>
              </div>
            </div>
            ...
            <p className="text-xs text-[#64748B] flex items-center gap-1.5 pt-2">
              ...
              SEBI registered fiduciary planning • Zero distributor markups • 100% Direct Plans
            </p>
          </motion.div>
